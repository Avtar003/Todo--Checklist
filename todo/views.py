...
def currenttodos(request):
    try:
        ...
        return render(request, 'todo/currenttodos.html',{'error':'you need to log in first'})
@login_required
def completedtodos(request):
    try:
        ...
        return render(request, 'todo/completedtodos.html',{'error':'you need to log in first'})
